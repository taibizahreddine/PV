...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['modifier'])) {
        ...
        $modification_query = "UPDATE formulaire SET nom = '$nouveau_nom', prenom = '$nouveau_prenom', situ = '$nouvelle_situ' WHERE id = $id_a_modifier";
...
if ($resultat) {
    if ($resultat->num_rows > 0) {
        ...
        echo "<table border='1'>";
        echo "<tr><th>ID</th><th>Nom</th><th>Prénom</th><th>date_naissance</th><th>lieu_naissance</th><th>filiere</th><th>Adresse</th><th>Code Postal</th><th>Nationalité</th><th>Situation</th><th>Système</th><th>Pays</th><th>Applications</th><th>Sexe</th><th>Operation1</th></tr>";
